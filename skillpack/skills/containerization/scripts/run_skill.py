#!/usr/bin/env python3
"""Thin wrapper script for containerization skill."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Generate Dockerfile and compose configs for services")
    parser.add_argument("--input", type=Path, required=True)
    parser.add_argument("--output-dir", type=Path, default=Path("./out/containerization"))
