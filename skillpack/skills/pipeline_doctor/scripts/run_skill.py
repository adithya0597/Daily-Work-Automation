#!/usr/bin/env python3
"""Thin wrapper script for pipeline-doctor skill."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Diagnose pipeline issues from logs and configs")
    parser.add_argument("--input", type=Path, required=True)
    parser.add_argument("--output-dir", type=Path, default=Path("./out/pipeline_doctor"))
