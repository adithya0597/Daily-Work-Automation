#!/usr/bin/env python3
"""Thin wrapper script for cost-regression skill."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Detect cost and performance regressions in pipelines")
    parser.add_argument("--input", type=Path, required=True)
    parser.add_argument("--output-dir", type=Path, default=Path("./out/cost_regression"))
