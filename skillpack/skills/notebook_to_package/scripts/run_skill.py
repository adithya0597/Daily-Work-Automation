#!/usr/bin/env python3
"""Thin wrapper script for notebook-to-package skill."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Convert Jupyter notebooks to Python packages")
    parser.add_argument("--input", type=Path, required=True)
    parser.add_argument("--output-dir", type=Path, default=Path("./out/notebook_to_package"))
