#!/usr/bin/env python3
"""Thin wrapper script for experiment-queue skill."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Manage experiment queue with checkpointing and concurrency")
    parser.add_argument("--input", type=Path, required=True)
    parser.add_argument("--output-dir", type=Path, default=Path("./out/experiment_queue"))
