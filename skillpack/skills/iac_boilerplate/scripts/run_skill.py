#!/usr/bin/env python3
"""Thin wrapper script for iac-boilerplate skill."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Create Terraform modules for cloud infrastructure")
    parser.add_argument("--input", type=Path, required=True)
    parser.add_argument("--output-dir", type=Path, default=Path("./out/iac_boilerplate"))
