#!/usr/bin/env python3
"""Thin wrapper script for evaluation-report skill."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Generate metrics, calibration, and slice analysis reports")
    parser.add_argument("--input", type=Path, required=True)
    parser.add_argument("--output-dir", type=Path, default=Path("./out/evaluation_report"))
