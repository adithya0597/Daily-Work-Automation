#!/usr/bin/env python3
"""Thin wrapper script for feature-engineering skill."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Suggest and generate feature transformations per column type")
    parser.add_argument("--input", type=Path, required=True)
    parser.add_argument("--output-dir", type=Path, default=Path("./out/feature_engineering"))
