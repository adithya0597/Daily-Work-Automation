...
def experiment_queue_main(
    ...
    try:
        ...
        files.append("experiments.yaml", output_dir=output_dir)
        ...
        files.append("checkpoint.json", output_dir=output_dir)
