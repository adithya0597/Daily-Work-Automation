...
def feature_engineering_main(
    ...
    try:
        ...
        write_text(content=features_code, filename="features.py", skill_name="feature_engineering", output_dir=output_dir)
        files.append("features.py")

        # Generate transformations reference
        transformations = generate_transformations_doc(columns)
        write_text(content=transformations, filename="transformations.md", skill_name="feature_engineering", output_dir=output_dir)
        files.append("transformations.md")

        # Generate config template
        config = generate_config_template(columns)
        write_text(content=config, filename="feature_config.yaml", skill_name="feature_engineering", output_dir=output_dir)
