...
def evaluation_report_main(
    ...
    try:
        ...
        write_text(content=report, filename="evaluation_report.md", skill_name="evaluation_report", output_dir=output_dir)
        files.append("evaluation_report.md")

        # Generate evaluation script
        eval_script = generate_eval_script(model_name, task_type)
        write_text(content=eval_script, filename="evaluate.py", skill_name="evaluation_report", output_dir=output_dir)
        files.append("evaluate.py")

        # Generate plotting script
        plot_script = generate_plot_script(task_type)
        write_text(content=plot_script, filename="plot_results.py", skill_name="evaluation_report", output_dir=output_dir)
