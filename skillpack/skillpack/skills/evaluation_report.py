"""evaluation-report - Generate metrics, calibration, and slice analysis reports"""
...
def register_parser(subparsers: Any) -> None:
    ...
    parser = subparsers.add_parser(
        "evaluation-report",
        help="Generate metrics, calibration, and slice analysis reports",
    )
    parser.add_argument(
        "--input",
        type=Path,
...
def evaluation_report_main(
    ...
    """Main implementation for evaluation-report."""
